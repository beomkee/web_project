...
<div class="dashboard-wrapper">
	...
	<script>
		...
		function search() {
			var searchData = $('#mf_num').val()+","+$('#f_num option:selected').val()+","+ $('#pl_num option:selected').val()+","+ $('#p_num').val()+","+$('#mf_count').val()+","+ $('#mf_date').val();
			
			var tableName = "manufacture";
			console.log(searchData);
			 $.ajax({                          
		        type: "POST",
		        url: "<%=request.getContextPath()%>/searchGrid.do",
