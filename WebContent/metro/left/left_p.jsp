...
<li class="has_submenu ngray"><a href="#"> <!-- Menu name with icon -->
		<i class="fa fa-sitemap"></i> 계약정보 <!-- Icon for dropdown --> <span
...
<li class="has_submenu ngray"><a href="#"> <i
		class="fa fa-file-o"></i> 입력폼 <span class="pull-right"><i
...
<li class="has_submenu ngray"><a href="#"> <i class="fa fa-th"></i>
		상품정보 <span class="pull-right"><i class="fa fa-angle-right"></i></span>
</a>
	<ul>
		<li><a href="calendar.html">Calendar</a></li>
		<li><a href="post.html">Make Post</a></li>
