					...
					<div class="col-md-12">
						...
						<ul class="today-datas">
							...
							<li class="bgreen">
								...
								<div class="datas-text pull-right">
									<span class="bold">30,000</span> Members
								</div>
									...
									<ul class="chats">
										...
										<li class="by-me">
											...
											<div class="avatar pull-left">
												<img src="<%=request.getContextPath()%>/metro/img/user.jpg" alt="" class="img-responsive" />
											</div>
										...
										<li class="by-other">
											...
											<div class="avatar pull-right">
												<img src="<%=request.getContextPath()%>/metro/img/user.jpg" alt="" />
											</div>
											<div class="chat-content">
						...
						<div class="widget wviolet">
							...
							<div class="widget-content">
								...
								<ul class="file-upload">
									<li>
										<!-- Icon with file name --> <strong><i
											class="fa fa-upload green"></i> File_Name_Here.Mp3</strong> <!-- Progress bar -->
										<div
											class="progress progress-animated progress-striped active">
										...
										<div class="file-meta">3.3 of 5MB - 5 mins - 1MB/Sec</div> <!-- Buttons -->
									...
									<li><strong><i class="fa fa-ok red"></i>
											Second_File.Mp3</strong>
										<div class="file-meta">5MB - 5 mins - Completed</div></li>
						...
						<div class="widget worange">
							...
							<div class="widget-content referrer">
								...
								<table class="table  table-bordered ">
									...
									<tr>
										<td><img src="<%=request.getContextPath()%>/metro/img/icons/chrome.png" alt="" /></td>
										<td>Google Chrome</td>
										<td>3,005</td>
									</tr>
									<tr>
										<td><img src="<%=request.getContextPath()%>/metro/img/icons/firefox.png" alt="" /></td>
										<td>Mozilla Firefox</td>
										<td>2,505</td>
									</tr>
									<tr>
										<td><img src="<%=request.getContextPath()%>/metro/img/icons/ie.png" alt="" /></td>
										<td>Internet Explorer</td>
										<td>1,405</td>
									</tr>
									<tr>
										<td><img src="<%=request.getContextPath()%>/metro/img/icons/opera.png" alt="" /></td>
										<td>Opera</td>
										<td>4,005</td>
									</tr>
									<tr>
										<td><img src="<%=request.getContextPath()%>/metro/img/icons/safari.png" alt="" /></td>
										<td>Safari</td>
										<td>505</td>
									</tr>
								</table>
